---
title: "Path of Exile 1 공식 패치노트 링크 모음"
date: 2026-09-17T16:45:00+09:00
draft: false
tags: ["패치노트", "업데이트", "리그", "아카이브"]
categories: ["POE1"]
---

짧은 요약:
- POE1(오리지널 패스 오브 엑자일) 공식 패치노트만 모은 링크 인덱스다. **POE2(0.x.x 버전)는 다루지 않는다** — POE2는 [별도 글](/posts/poe2-official-patch-notes-index/)에 있다.
- 패치노트 원문은 옮기지 않았고, 공식 포럼(pathofexile.com) 링크만 정리했다.
- 새 패치가 나올 때마다 이 글의 표에 행을 추가하는 방식으로 계속 갱신할 예정이다.
...
- [3.28.0i Patch Notes](https://www.pathofexile.com/forum/view-thread/3934129) — 2026-05-30
- [3.28.0j Patch Notes](https://www.pathofexile.com/forum/view-thread/3974219) — 2026-06-24

3.27.0(Keepers of the Flame)과 3.26.0(Secrets of the Atlas)도 각각 여러 알파벳 패치가 있었으나, 이번 조사에서는 메이저 버전 링크만 확인했다. 후속 패치 링크는 확인되는 대로 추가할 예정이다.

## 더 과거 패치

3.25.0(2024-07) 이전 패치는 이번 조사 범위 밖이다. 그보다 오래된 버전은 공식 포럼 인덱스에서 직접 확인할 수 있다.

- [Patch Notes – Forum – Path of Exile (공식 인덱스)](https://www.pathofexile.com/forum/view-forum/patch-notes)
...
- POE1 공식 패치노트는 pathofexile.com 포럼에서 발행되며, 이 글은 최근 2년치(3.25.0~3.29.0) 메이저 리그 패치를 최신순으로 정리했다.
- 알파벳 후속 패치(3.29.1, 3.28.0b 등)도 확인된 만큼 링크를 모아뒀다.
- 더 과거 패치는 공식 포럼 인덱스에서 직접 찾아야 한다.
